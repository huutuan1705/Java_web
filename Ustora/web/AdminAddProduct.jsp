<%-- 
    ...
    Created on : Feb 23, 2023, 4:12:29 PM
...
<body>
    ...
    <div class="single-product-area">
        <div class="container">
            ...
            <form class="form-horizontal" action="adminadd" method="post" enctype="multipart/form-data">
                <!-- product id -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="product_name" name="product_type" placeholder="PRODUCT CATEGORY" class="form-control input-md" required="" type="text">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input name="file" id="filebutton" class="input-file" type="file">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input id="filebutton" class="btn btn-primary" type="submit" value="ADD PRODUCT">
                    </div>
                </div>
            </form>           
        </div>
