...
import com.server.SystemIntelligent.model.TrafficTrainDataset;
...
public class TrafficLightSampleDAO extends DAO {
    ...
    public void updateSample(TrafficLightSample sample){
        String sql1 = "UPDATE traffic_light_sample SET nameImg = ? WHERE idTrafficSpl = ?";
        try{
            PreparedStatement ps1 = connection.prepareStatement(sql1);
            ps1.setString(1, sample.getNameImg());
            ps1.setString(2, sample.getIdTrafficSample());
